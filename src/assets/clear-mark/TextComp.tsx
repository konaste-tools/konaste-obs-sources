  ...
  return (
    <svg className="clear-mark-text" viewBox="0 0 150 150">
      <g id="letterC" transform={`translate(${offset}, ${verticalOffset})`}>
        <LetterC gradient="letter_linear_comp" />
      </g>
      <g
        id="letterO"
        transform={`translate(${offset + 23}, ${verticalOffset})`}
      >
        <LetterO gradient="letter_linear_comp" />
      </g>
      <g
        id="letterM"
        transform={`translate(${offset + 46}, ${verticalOffset})`}
      >
        <LetterM gradient="letter_linear_comp" />
      </g>
      <g
        id="letterP"
        transform={`translate(${offset + 75}, ${verticalOffset})`}
      >
        <LetterP gradient="letter_linear_comp" />
      </g>

      <defs>
        <linearGradient
          id={`letter_linear_comp`}
          x1="15"
          y1="4"
          x2="15"
          y2="20"
